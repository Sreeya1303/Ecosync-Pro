...
const LoginPage = () => {
    ...
    if (showLocationPrompt) {
        return (
            <div className="h-screen w-full bg-[#020617] flex items-center justify-center relative overflow-hidden font-outfit text-slate-200">
                <div className="absolute inset-0 bg-grid-slate-900/[0.04] bg-[size:40px_40px]"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-transparent to-transparent"></div>

                <div className="relative z-10 w-full max-w-md p-8">
                    <div className="glass-panel p-10 border border-white/10 backdrop-blur-2xl rounded-[2.5rem] text-center animate-in zoom-in duration-700 shadow-2xl">
                        <div className="w-20 h-20 bg-cyan-500/10 rounded-3xl flex items-center justify-center mx-auto mb-8 border border-cyan-500/30 group">
                            <Navigation className="text-cyan-400 w-10 h-10 group-hover:scale-110 transition-transform" />
                        </div>
                        ...
                        <div className="space-y-6">
                            <button
                                ...
                                className="w-full py-5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold rounded-2xl flex items-center justify-center gap-3 transition-all shadow-[0_10px_30px_rgba(6,182,212,0.3)] hover:shadow-[0_15px_40px_rgba(6,182,212,0.4)] disabled:opacity-50"
                            >
                            ...
                            <form onSubmit={handleManualSubmit} className="flex gap-3">
                                <input
                                    className="flex-1 bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white outline-none focus:border-cyan-500 focus:bg-white/10 transition-all font-light"
                                ...
                                <button
                                    ...
                                    className="bg-white/10 hover:bg-white/20 text-white px-6 rounded-2xl font-black transition-all border border-white/10"
                                >
                                    GO
                                </button>
                            </form>
    ...
    return (
        <div className="h-screen w-full bg-[#020617] flex items-center justify-center relative overflow-hidden font-outfit text-slate-200">
            ...
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-500/10 blur-[120px] rounded-full translate-y-1/2 -translate-x-1/2"></div>

            <div className="relative z-10 w-full max-w-md p-6">
                <div className="glass-panel p-10 border border-white/10 backdrop-blur-3xl rounded-[3rem] shadow-[0_20px_60px_rgba(0,0,0,0.5)] border-t-white/20">

                    <div className="text-center mb-10">
                        <div className="w-20 h-20 bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 rounded-[2rem] flex items-center justify-center mx-auto mb-6 border border-white/10 shadow-inner group">
                        ...
                        <p className="text-cyan-400/50 text-[10px] font-bold tracking-[0.3em] uppercase">
                    ...
                    <form onSubmit={handleLogin} className="space-y-8">
                        <div className="space-y-5">
                            <div className="group">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="email"
                                        className="block w-full pl-14 pr-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] focus:ring-0 focus:border-cyan-500 placeholder-slate-600 text-white transition-all outline-none font-light"
                        ...
                        {/* Plan Selection UI */}
                        <div className="pt-2">
                            <label className="block text-[10px] font-bold text-slate-500 mb-4 ml-1 tracking-widest uppercase">Selection Protocol</label>
                            <div className="grid grid-cols-2 gap-4">
                                <div
                                    onClick={() => setPlan('lite')}
                                    className={`cursor-pointer p-5 rounded-[1.5rem] border transition-all duration-300 ${plan === 'lite' ? 'bg-emerald-500/10 border-emerald-500/50 shadow-[0_0_20px_rgba(16,185,129,0.2)]' : 'bg-white/5 border-white/10 hover:border-white/20'}`}
                                >
                                ...
                                <div
                                    onClick={() => setPlan('pro')}
                                    className={`cursor-pointer p-5 rounded-[1.5rem] border transition-all duration-300 ${plan === 'pro' ? 'bg-cyan-500/10 border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.2)]' : 'bg-white/5 border-white/10 hover:border-white/20'}`}
                                >
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full relative group overflow-hidden bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-black py-5 px-6 rounded-[1.5rem] transition-all duration-500 transform hover:scale-[1.02] active:scale-95 disabled:opacity-50 shadow-[0_15px_30px_rgba(6,182,212,0.3)]"
                        >
